...
export default function Identifier(props: Props) {
  ...
  const { sendOTPMutation, isTelegram, isBrowser } = useWalletAuth();
    ...
    <div className="flex flex-col w-full h-full items-center justify-between p-5 pb-10">
      ...
      <div className="flex flex-col gap-5 w-full h-4/5">
        ...
        <div>
          ...
          {isBrowser && (
            <p className="text-sm text-gray-600 mt-1">
              Running in browser mode - phone number will be used as your
              identifier
            </p>
          )}
          {isTelegram && (
            <p className="text-sm text-gray-600 mt-1">
              Running in Telegram - phone number required for verification
            </p>
          )}
        </div>
        ...
        <p className="text-muted-foreground">
          ...
          {isBrowser
            ? "authentication and as your account identifier"
