...
export default function SendRequestLink({ renderSendReqLink, requestLink }: sendRequestLinkProps) {
        ...
        <Drawer open={isOpen} onClose={onClose} onOpenChange={(open) => {
            ...
            <DrawerContent>
                ...
                <div className="w-full flex flex-col items-center p-5 h-[30vh] gap-4 justify-between">
                    <p className="text-center font-semibold">Your crypto request link was created successfully <br /> <span className="text-md font-light">Copy & share it to receive crypto in your wallet</span> </p>
