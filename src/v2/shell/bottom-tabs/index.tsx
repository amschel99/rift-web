  ...
  },
  {
    ...
    render(field, active) {
      return (
        ...
        >
          {active ? (
            <FaMoneyBillTransfer className="text-3xl text-accent-primary" />
          ) : (
            <FaMoneyBillTransfer className="text-3xl text-accent-foreground/50" />
          )}
        </div>
      );
    },
  ...
  },
  {
    ...
    render(field, active) {
      return (
        ...
        >
          {active ? (
            <MdExplore className="text-3xl text-accent-primary" />
          ) : (
            <MdOutlineExplore className="text-3xl text-accent-foreground/50" />
          )}
        </div>
      );
    },
